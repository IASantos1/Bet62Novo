declare global {
  ...
  namespace React {
    ...
    export type Key = any; export type Context<T> = any;
    ...
    export type AreaHTMLAttributes<T = any> = any;
    export type BaseHTMLAttributes<T = any> = any;
    export type BlockquoteHTMLAttributes<T = any> = any;
    export type BodyHTMLAttributes<T = any> = any;
    ...
    export type DataHTMLAttributes<T = any> = any;
    export type DelHTMLAttributes<T = any> = any;
    export type DetailsHTMLAttributes<T = any> = any;
    ...
    export type KeygenHTMLAttributes<T = any> = any;
    ...
    export type MenuHTMLAttributes<T = any> = any;
    export type MetaHTMLAttributes<T = any> = any;
    export type MeterHTMLAttributes<T = any> = any;
    export type ObjectHTMLAttributes<T = any> = any;
    export type OlHTMLAttributes<T = any> = any;
    export type OptgroupHTMLAttributes<T = any> = any;
    ...
    export type SlotHTMLAttributes<T = any> = any;
    ...
    export type SpanHTMLAttributes<T = any> = any;
    ...
    export type TitleHTMLAttributes<T = any> = any;
    ...
    export type WebViewHTMLAttributes<T = any> = any;
    ...
    export const useReducer: any; export const useLayoutEffect: any; export const useImperativeHandle: any;
    export const useId: any; export const useSyncExternalStore: any;
    export const createContext: any; export const createElement: any; export const cloneElement: any;
    export const isValidElement: any; export const Children: any;
    export const memo: any; export const forwardRef: any; export const startTransition: any;
    export const Suspense: any; export const lazy: any; export const Fragment: any;
    export const StrictMode: any; export const Profiler: any; export const version: any;
