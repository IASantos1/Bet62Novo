...
const footballCases: FinishedSettlementCase[] = [
  ...
  {
    name: "football home team corners over is settled as won",
    selection: makeSelection("ohc4.5"),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 5, cornersAway: 3 },
    expected: "won",
  },
  {
    name: "football home team corners under is settled as lost",
    selection: makeSelection("uhc4.5"),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 5, cornersAway: 3 },
    expected: "lost",
  },
  {
    name: "football away team corners over is settled as won",
    selection: makeSelection("oac2.5"),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 5, cornersAway: 3 },
    expected: "won",
  },
  {
    name: "football away team corners exact line is settled as void",
    selection: makeSelection("uac3"),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 5, cornersAway: 3 },
    expected: "void",
  },
  {
    name: "football corners handicap home is settled as won",
    selection: makeSelection("corh-home", { marketLine: -1.5 }),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 6, cornersAway: 3 },
    expected: "won",
  },
  {
    name: "football corners handicap away is settled as lost",
    selection: makeSelection("corh-away", { marketLine: 1.5 }),
    ft: { home: 1, away: 0 },
    extra: { cornersHome: 6, cornersAway: 3 },
    expected: "lost",
  },
  {
    name: "football home team cards over is settled as won",
    selection: makeSelection("ohcards1.5"),
    ft: { home: 1, away: 0 },
    extra: { cardsHome: 2, cardsAway: 1 },
    expected: "won",
  },
  {
    name: "football away team cards under is settled as won",
    selection: makeSelection("uacards1.5"),
    ft: { home: 1, away: 0 },
    extra: { cardsHome: 2, cardsAway: 1 },
    expected: "won",
  },
