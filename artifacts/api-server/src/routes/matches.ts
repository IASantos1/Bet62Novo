...
// updates using our own match id directly. Pure cache read
// (tickDirectTracker refreshes it on its own interval), so this is safe to
// poll frequently without triggering new upstream calls.
